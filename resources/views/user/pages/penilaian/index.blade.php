            ...
            <div class="flex justify-between">
                <div class="min-h-full w-full">
                    <div class="flex items-center">
                        ...
                        <div class="bg-gradient-to-b from-sky-500 to-sky-300 shadow-xl w-[10%] flex items-center justify-center p-5 rounded-s-lg">
                    ...
                    <div class="px-4 sm:px-12 pt-5 pb-12">
                        ...
                        <div class="flex justify-end w-full z-50">
                            <form method="GET">
                                <div class="flex">
                                    <input type="text" name="search" placeholder="Cari Data" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block p-2.5">
                                    <button type="submit"
                                        class="ml-2 px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600"><i class="fas fa-search"></i></button>
                                </div>
                            </form>
                        </div>
                        {{-- end search --}}
