<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('index') }}">
            <img src={{ asset('img/mjamil.webp') }} class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Kelompok B</span>
        </a>
    </div>
            ...
            {{-- Penilaian --}}
                <li class="nav-item">
                    <a class="nav-link {{ $page == 'penilaian' ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Penilaian Risiko Jatuh</span>
                    </a>
                </li>
